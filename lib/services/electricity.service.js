...
class ElectricityService {
    ...
    async getMeterInfo(request) {
        ...
        const hash = (0, hmac_1.default)([this.#vendorCode, referenceId, meter, disco.valueOf(), this.#publicKey], this.#privateKey);
        try {
    ...
    async buy(request) {
        ...
        const hash = (0, hmac_1.default)([this.#vendorCode, referenceId, meter, disco.valueOf(), String(amount), String(accessToken), this.#publicKey], this.#privateKey);
        try {
